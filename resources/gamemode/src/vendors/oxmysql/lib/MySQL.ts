...
function ready(callback: () => void) {
  setImmediate(() => {
    while (GetResourceState('gamemode') !== 'started') Wait(50);
    callback();
  });
}
...
function query<T = any>(query: Query, parameters?: Params, cb?: Callback<T>): Promise<T | null> | void {
  if (cb) return exports.gamemode.query(...safeArgs(query, parameters, cb));
  return exports.gamemode.query_async(...safeArgs(query, parameters));
}
...
function single<T = Record<string | number, any>>(
  ...
  if (cb) return exports.gamemode.single(...safeArgs(query, parameters, cb));
  return exports.gamemode.single_async(...safeArgs(query, parameters));
}
...
function scalar<T = unknown>(query: Query, parameters?: Params, cb?: Callback<T>): Promise<T | null> | void {
  if (cb) return exports.gamemode.scalar(...safeArgs(query, parameters, cb));
  return exports.gamemode.scalar_async(...safeArgs(query, parameters));
}
...
function update(query: Query, parameters?: Params, cb?: Callback<number>): Promise<number | null> | void {
  if (cb) return exports.gamemode.update(...safeArgs(query, parameters, cb));
  return exports.gamemode.update_async(...safeArgs(query, parameters));
}
...
function insert(query: Query, parameters?: Params, cb?: Callback<number>): Promise<number | null> | void {
  if (cb) return exports.gamemode.insert(...safeArgs(query, parameters, cb));
  return exports.gamemode.insert_async(...safeArgs(query, parameters));
}
...
function prepare<T = unknown>(query: Query, parameters?: Params, cb?: Callback<T>): Promise<T | null> | void {
  if (cb) return exports.gamemode.prepare(...safeArgs(query, parameters, cb));
  return exports.gamemode.prepare_async(...safeArgs(query, parameters));
}
...
function transaction(query: Query, parameters?: Params, cb?: Callback<boolean>): Promise<boolean> | void {
  if (cb) return exports.gamemode.transaction(...safeArgs(query, parameters, cb, true));
  return exports.gamemode.transaction_async(...safeArgs(query, parameters, undefined, true));
}
